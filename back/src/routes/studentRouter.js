...
studentRouter.post("/", async (req, res)=>{
    ...
    const { nombres, apellidos, dni, genero, edad, email, plan, id_departamento } = req.body;
    
        try {
            const newStudent = await createStudent(nombres, apellidos, dni, genero, edad, email, plan, id_departamento)
...
studentRouter.put("/:id", async (req, res)=>{
    const{ id }  = req.params ;
    const{ nombres, apellidos, dni, genero, edad, email, id_departamento, id_plan}= req.body;
    try {
        const actualizarEstudiante = await updateStudent(id, nombres, apellidos, dni, genero, edad, email, id_departamento, id_plan );
