...
// Esto sirve para...
const createStudent = async (nombres, apellidos, dni, genero, edad, email, plan, id_departamento)=>{
...
// Esto sirve para...  
    ...
    const newStudent = await Estudiante.create({nombres, apellidos, dni, genero, edad, email, id_plan, id_departamento})
    return newStudent;
}
...
const updateStudent = async(id, nombres, apellidos, dni, genero, edad, email, id_departamento, id_plan)=>{
    const findStudent= await Estudiante.findByPk(id);

    const studentUpdate = await findStudent.update({nombres, apellidos, dni, genero, edad, email, id_plan, id_departamento})
